...
class DataTransfermationConfig:
    preprocessor_obj_file_path = os.path.join("D:/ML projects/diamond pricing",'artifacts','preprocessor.pkl')
    
class DataTransfermation:
    def __init__(self):
        self.data_transfermation_config = DataTransfermationConfig()
        
    def get_data_tranfermation_obj(self):
        try:
            logging.info("Data Transfermation initiated")
            ...
            logging.info(f"Error in Data Trnasformation {str(e)}")
    ...
    def initiate_data_transfermation(self,train_path,test_path):
        try:
            ...
            preprocessing_obj = self.get_data_tranfermation_obj()
            ...
            #transfermation using processor obj
            ...
            logging.info('exception occured in initiate_datatransformer')
